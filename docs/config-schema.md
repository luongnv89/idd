...
| `.gitissue/model-data.json` | `/issue-creator` | Cached CursorBench model scoring data (seeded from the skill bundle; refreshed on opt-in) — used for model suggestions. Only when `model_suggestion.enabled` |
