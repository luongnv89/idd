...
- **Binary skip.** `binary`-charset files skip real-key scanning (avoids slow, FP-prone scans). **Residual risk (#276):** NUL-sniff proxy misses evasions; filename/size rules still fire. Gitleaks closed this ask (#1541) not planned.
