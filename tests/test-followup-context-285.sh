...
PH="$(spec_concat "$ROOT/src/skills/auto-pilot/references/phases.md")"
...
RS="$(spec_concat "$ROOT/src/skills/issue-resolver/references/pipeline-steps.md")"
...
BRS="$(spec_concat "$ROOT/skills/issue-resolver/references/pipeline-steps.md")"
...
anchor_check "$BRS" rs-step0i-ordering 'concurrent|mismatch' "generated copy carries concurrent-edit fallback: skills/issue-resolver/references/steps/step-0i-caller-payload.md"
