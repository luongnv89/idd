...
All skills that create branches, commits, PRs, or issues follow these conventions. The full standalone reference is at `src/docs/naming-conventions.md` — skills reference that document directly so the conventions work with any tool, not just Codex.
