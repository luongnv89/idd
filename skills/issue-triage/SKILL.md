...
Triage settings, with their defaults — full semantics in `references/docs/config-schema.md`
...
both — is `references/agents/issue-relationship-scanner.md`. Batches run in parallel
