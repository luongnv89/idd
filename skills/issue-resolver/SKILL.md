...
Write code and tests based on the selected plan. Spawn the `implementer` subagent (see `references/agents/implementer.md`) with the plan, branch name, naming conventions, and the `selected_skills` chosen above. Use this Agent invocation:
