...
- `model` / effort: role `autopilot-resolver` — per `references/docs/agent-overrides.md`; omit when `null`
...
- `model` / effort: role `autopilot-reviewer` — per `references/docs/agent-overrides.md`; omit when `null`
...
- `model` / effort: role `autopilot-analyzer` — per `references/docs/agent-overrides.md`; omit when `null`
