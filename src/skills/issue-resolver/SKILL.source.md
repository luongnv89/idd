...
**Policy ceiling:** light=1; full+low/medium=2; full+high=`resolve.qa_max_cycles`
(hard cap, default 5). Record `ceiling`/`breach_reason` (*Step 4 — QA*).
